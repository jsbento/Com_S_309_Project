...
public class leaveGroupTest 
{
	...
	@Test
	public void testUserLeaveGroup() throws Exception
	{
		User testUser = new User();
		testUser.setUserName("testUser");
		testUser.setUserID("F2020TestUser");
		...
		controller.perform(put("/user/1/group/1/leave"))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$.userID", is("F2020TestUser")));
